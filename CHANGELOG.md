...
- Sidebar panel shadow now has rounded bottom corners; `cornerRadius = 10` / `cornerCurve = .continuous` set on sidebar layer so the macOS 26 compositor shadow follows the panel shape (B12)
